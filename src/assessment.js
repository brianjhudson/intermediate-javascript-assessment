...
scopeArray2.splice(0, 1).splice(2, 2);
...
function compareValues(num1, num2) {
  if (num1 === num2) return "Exact match";
  else if (num1 == num2) return "Different types";
